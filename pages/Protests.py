...
layout = html.Div([
    # The five graphs A, B, CD, E, and F are placed here.
    dcc.RangeSlider(
        id='year-slider',
        min=df['year'].min(),
        max=df['year'].max(),
...
#                                     ]
#                                 ),
#                                 dcc.Graph(id = 'compare_graph_num1'),
#                             ]
#                         ),
#                     ]
#                 ),
...
def update_graph_a(year_range):
    ...
    return fig
#
# @app.callback(Output('compare_graph_num1', 'figure'),
#                 Input('column_name_num1','value'))
...
#
#
# @app.callback(Output('cat-table1', 'children'),
#                 Output('cat-table1', 'opened'),
#                 Input('categorical-table1', 'n_clicks'),
#                 State('cat-table1', 'opened'),
...
#     ), not opened
#
# @app.callback(Output('table123', 'children'),
#                 Output('table456', 'opened'),
#                 Input('tablenums123', 'n_clicks'),
#                 State('tablenums456', 'opened'),
#                 prevent_inital_call = True)
# def update_modal_cat(n, opened):
#
#     if ctx.triggered_id is None:
